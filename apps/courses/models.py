...
class Course(models.Model):
    ...
    categroy = models.CharField(max_length=30,verbose_name=u'课程类别',default=u'后端开发',blank=True)
    #为了在课程详情页显示"相关推荐课程"，此处定义一个类别标签用于标示相关的一些课程
    tag = models.CharField(max_length=20,verbose_name=u'相关课程标签',default="")
